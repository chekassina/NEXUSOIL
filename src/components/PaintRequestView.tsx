...
const PAINT_PRODUCTS: PaintProduct[] = [
  {
    ...
    description:
      'Bespoke high-opacity aerosol spray can loaded with professional acrylic basecoat paint mixed precisely to your original vehicle OEM color code. Features an adjustable fan-spray nozzle.',
    features: [
      'Precision-matched basecoat formula',
      'Adjustable fan-spray aerosol nozzle',
      'Superior coverage & adhesion',
      'Fast-drying & sun-resistant paint',
    ],
    customizable: true,
  ...
  },
  {
    ...
    description:
      'Consolidated touch-up kit featuring a double-ended applicator (needle pen tip for deep stone chips, and a soft hair brush for wider panel scuffs). Mixed exact-to-code.',
    features: [
      'Exact factory color shade matching',
      'Pen & brush dual-end premium design',
      'Formulated with anti-rust inhibitors',
      'Complete paint prep guidelines included',
    ],
    customizable: true,
  ...
  },
  {
    ...
    description:
      'High-density solids ratio paint designed specifically for professional pneumatic spray guns. Available in basecoat or 2K direct-gloss format to match your car perfectly.',
    features: [
      'High concentration of pigments',
      'Perfect for full panels & restoration',
      'Excellent flow and leveling qualities',
      'Extreme durability against chips',
    ],
    customizable: true,
  ...
  },
  {
    ...
    image: '/images/lp13.jpg',
    description:
      'Premium high-build solvent-based protective enamel. Formulated for heavy-duty metal chassis, engine compartments, underbody, and high-impact areas requiring robust weathering defense and anti-corrosive power.',
    features: [
      'High-solid solvent-based enamel',
      'Heavy-duty chemical & water barrier',
      'Ultra-tough impact & scratch durability',
      'Excellent brush, roller, or spray application',
    ],
    customizable: true,
    defaultQuantity: '1.0 Litre Spray Tin',
  },
  {
    ...
    image: '/images/lp13.jpg',
    description:
      'Two-component highly durable clear coat lacquer. Activating the canister triggers a chemical cross-link that yields a petrol-resistant, scratch-resistant, and high-gloss glaze.',
    features: [
      'Internal hardener activation button',
      'Maximum chemical & weather resistance',
      'Provides deep glass-like gloss depth',
      'Full UV protection prevents fading',
    ],
    customizable: false,
    defaultQuantity: 'Aerosol Spray Can (400ml)',
  },
  {
    ...
    image: '/images/lp11.jpg',
    description:
      'Universal high-build spray primer that provides an outstanding anti-rust corrosion barrier. Essential for sealing bare metal or plastic before applying basecoats.',
    features: [
      'Prevents metal rust spread',
      'Super easy wet-and-dry sandability',
      'High-build filling of minor scratches',
      'Compatible with all topcoat brands',
    ],
    customizable: false,
    defaultQuantity: 'Aerosol Spray Can (400ml)',
  },
  {
    ...
    image: '/images/lp10.jpg',
    description:
      "Pre-saturated surface cleaning wipes loaded with fast-flashing solvent degreaser. Safely dissolves all wax, grease, oil, silicone, and dust before coating.",
    features: [
      'Fast evaporation, leaves zero residue',
      "Heavy duty cloth, won't lint or tear",
      'Ensures maximum paint-to-metal bonding',
      '15 extra-large pre-saturated wipes',
    ],
    customizable: false,
  ...
  },
  {
    ...
    image: '/images/lp13.jpg',
    description:
      'Consolidated wet-and-dry abrasive block detailing pack featuring premium P1200, P2000 and P3000 grit sandpapers, a rubber backing block, and ultra-cut finishing polish compound.',
    features: [
      'Smoothes clearcoat transition borders',
      'Eliminates orange-peel surface textures',
      'Excellent paint edge-blending properties',
      'Includes professional-grade heavy polish',
    ],
    customizable: false,
...
export default function PaintRequestView() {
  ...
  const [selectedCategory, setSelectedCategory] = useState<
    'All' | 'Custom Matches' | 'Finishes & Primers' | 'Prep & Accessories'
  >('All');
  ...
  const handleSelectCustomProduct = (product: PaintProduct) => {
    ...
    setPrefilledMessage(
      `You selected: ${product.name}. We pre-filled the quantity! Enter your vehicle details below to match the color.`
    );
  ...
  const handleAIMatchAnalysis = async () => {
    if (!formData.vehicleBrand || !formData.model || !formData.year) {
      setAiError(
        'Please provide Vehicle Brand, Model, and Year in the form before requesting an AI color matching analysis.'
      );
      return;
    }
    setLoadingAI(true);
    ...
    try {
      ...
      setAiError(
        err.message ||
          'AI color matching is currently busy. Please fill out details manually.'
      );
    } finally {
      setLoadingAI(false);
    }
  ...
  const getWhatsAppSubmitLink = () => {
    const text = `Hello LubriCoat! I would like to confirm my automotive paint request:\nRequest ID: ${
      ...
      formData.year
    } ${formData.vehicleBrand} ${formData.model}\nStated Color: ${
      formData.colorName || 'Not specified'
    }\nColor Code: ${formData.paintCode || 'Not specified'}\nFinish Style: ${
      formData.desiredFinish
  ...
  const inputClass =
    'w-full bg-neutral-50 border border-neutral-200 rounded-xl px-3.5 py-3 text-sm text-neutral-900 focus:ring-1 focus:ring-orange-500 focus:outline-none placeholder-neutral-400 min-w-0';
  const labelClass = 'block text-neutral-600 font-bold text-xs mb-1.5';

  return (
    <div
      id="paint-request-view"
      className="w-full max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-5 sm:py-8 lg:py-10 overflow-x-hidden"
    >
      {/* ── Header ── */}
      <div className="border-b border-neutral-200 pb-4 sm:pb-5 mb-5 sm:mb-8 space-y-3 sm:space-y-4">
        <div>
          <h1 className="text-xl sm:text-3xl lg:text-4xl font-extrabold text-neutral-950 uppercase tracking-tight leading-tight">
            Automotive Paint{' '}
            <span className="text-orange-600">Shop & Lab</span>
          </h1>
          <p className="text-neutral-500 text-xs sm:text-sm mt-1.5 max-w-3xl leading-relaxed">
            We manufacture premium OEM color-matched finishes. Browse our specialized catalog
            of refinishing coats and prep kits, or use our Bespoke Formulation Lab to mix
            paint directly to your car's factory paint code.
          </p>
        </div>
        ...
        <div className="bg-slate-100 p-1 rounded-xl flex border border-slate-200/80 w-full sm:w-auto sm:self-start">
          <button
            ...
            className={`flex-1 sm:flex-none px-3 sm:px-5 py-2.5 rounded-lg text-xs font-bold transition-all flex items-center justify-center gap-1.5 whitespace-nowrap ${
              activeSubTab === 'shop'
      ...
      {activeSubTab === 'shop' ? (
        <div className="space-y-5 sm:space-y-8">
          {/* Filters Bar */}
          <div className="bg-white border border-slate-200/80 rounded-2xl p-3 sm:p-4 flex flex-col gap-3 shadow-sm">
            {/* Search */}
          ...
          {filteredProducts.length === 0 ? (
            <div className="bg-white rounded-3xl border border-slate-200 p-8 sm:p-10 text-center max-w-sm mx-auto space-y-3">
              ...
              <p className="text-xs text-neutral-500">
                Try clearing your filters or head to the Formulation Lab for custom mixes.
              </p>
              <button
                onClick={() => {
                  setSearchQuery('');
            ...
            /* 1 col on mobile, 2 col sm+, 3 col xl+ */
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
              {filteredProducts.map((product) => (
                <div
                  key={product.id}
                  className="bg-white rounded-2xl border border-neutral-200/80 overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col"
                >
                  {/* Image */}
                  <div className="h-40 sm:h-48 bg-slate-100 relative overflow-hidden group">
                    <img
                      src={product.image}
                      alt={product.name}
                    ...
                    />
                    <span className="absolute top-2.5 left-2.5 bg-slate-950 text-white text-[9px] font-bold px-2 py-0.5 rounded-md uppercase tracking-wide">
                      {product.category}
                    </span>
                    {product.customizable && (
                      <span className="absolute top-2.5 right-2.5 bg-orange-600 text-white text-[9px] font-bold px-2 py-0.5 rounded-md uppercase tracking-wide flex items-center gap-0.5">
                        <Sparkles size={9} />
                  ...
                  <div className="p-4 flex flex-col flex-1 space-y-3">
                    ...
                    <div className="flex justify-between items-start gap-2">
                      <h3 className="font-extrabold text-slate-950 text-sm leading-snug line-clamp-2 flex-1 min-w-0">
                        {product.name}
                      </h3>
                      <span className="text-sm font-black text-slate-950 shrink-0 whitespace-nowrap ml-1">
                    ...
                    <div className="mt-auto pt-2">
                      {product.customizable ? (
                        <button
                          ...
                          className="w-full py-3 bg-orange-600 hover:bg-orange-500 active:scale-95 text-white text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-1.5"
                        >
                          <Paintbrush size={13} />
                        ...
                        <a
                          ...
                          className="w-full py-3 bg-slate-900 hover:bg-slate-700 active:scale-95 text-white text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-1.5"
                        >
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="space-y-1.5 max-w-2xl">
                ...
                <h4 className="text-base sm:text-lg font-black tracking-tight text-white">
                  Need a complete repair package?
                </h4>
                <p className="text-slate-400 text-xs leading-relaxed">
                  If you are re-spraying whole bumpers or doors, our dispatchers coordinate
                  bulk kits containing customized OEM spray paint basecoats, 2K clearcoats,
                  and plastic adhesion primers at deep commercial discounts.
                </p>
              </div>
              <button
                onClick={() => {
                  setFormData((prev) => ({
                    ...prev,
                    quantity: 'Refinishing Kit (Paint+Clear+Primer)',
                  }));
                  setActiveSubTab('formulation');
                }}
                className="w-full sm:w-auto px-5 py-3 bg-white hover:bg-slate-100 active:scale-95 text-slate-950 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1 shrink-0"
              >
          ...
          {success ? (
            ...
            <div className="bg-white border border-neutral-200 rounded-3xl p-6 sm:p-12 shadow-md max-w-lg mx-auto text-center space-y-5">
              ...
              <div className="space-y-2">
                <h2 className="text-xl sm:text-2xl font-extrabold text-neutral-950">
                  Paint Request Received!
                </h2>
                <p className="text-neutral-500 text-sm leading-relaxed">
                  Thank you,{' '}
                  <span className="font-bold text-neutral-950">{formData.customerName}</span>
                  . Your paint specs have been queued. Our lab team will confirm availability
                  and pricing shortly.
                </p>
              </div>

              <div className="bg-neutral-50 rounded-2xl p-4 border border-neutral-100 text-left text-xs space-y-2.5">
                <h4 className="font-bold text-neutral-800 uppercase tracking-wide text-[10px]">
                  Inquiry Summary
                </h4>
                {[
                  ...
                  [
                    'Vehicle',
                    `${formData.year} ${formData.vehicleBrand} ${formData.model}`,
                  ],
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-12 gap-5 lg:gap-10 items-start">
              ...
              <form
                ...
                className="w-full lg:col-span-7 bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-8 border border-neutral-200 shadow-sm space-y-5 sm:space-y-6 min-w-0"
              >
                ...
                <div className="space-y-3 pt-4 border-t border-neutral-100">
                  ...
                  {/* Make / Model / Year — stacks to 1-col on xs, 3-col on sm+ */}
                    ...
                    <div className="min-w-0">
                      <label className={labelClass + ' flex items-center gap-1'}>
                        ...
                        <Info
                          ...
                          title="Found on the chassis plate or door pillar sticker"
                        />
                      </label>
                      <input
                        type="text"
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, paintCode: e.target.value })
                        }
                        className={inputClass}
                      />
                    </div>
                ...
                <div className="space-y-3 pt-4 border-t border-neutral-100">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="min-w-0">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, desiredFinish: e.target.value as any })
                        }
                        className={inputClass}
                      >
                    ...
                    <div className="min-w-0">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setFormData({ ...formData, paintType: e.target.value as any })
                        }
                        className={inputClass}
                      >
                  ...
                  <div className="min-w-0">
                    ...
                    <select
                      ...
                      className={inputClass}
                    >
                      <option value="Touch Up Pot (50ml Brush Pot)">
                        Touch Up Pot (50ml + Applicator)
                      </option>
                      ...
                      <option value="Refinishing Kit (Paint+Clear+Primer)">
                        Refinishing Kit (Paint+Clear+Primer)
                      </option>
                    </select>
                  </div>
                  <div className="min-w-0">
                  ...
                  {!imageBase64 ? (
                    ...
                    >
                      ...
                      <span className="font-bold text-neutral-700 text-xs">
                        Upload Vehicle Photo or Paint Sticker
                      </span>
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-3 flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3 overflow-hidden min-w-0">
                        <div className="h-12 w-12 sm:h-14 sm:w-14 bg-slate-100 rounded-xl border border-slate-200 overflow-hidden shrink-0">
                          <img
                            src={imageBase64}
                            alt="Preview"
              ...
              {/* ── AI Sidebar ── */}
              <aside className="w-full lg:col-span-5 space-y-4 sm:space-y-5 min-w-0">
                {/* AI Match Card */}
                <div className="bg-slate-950 text-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-slate-900 shadow-xl space-y-4 sm:space-y-5 relative overflow-hidden">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <p className="text-slate-400 text-xs leading-relaxed">
                      Run our real-time AI paint matcher before submitting. It analyzes your
                      vehicle specs and uploaded sticker photo to retrieve original paint codes,
                      primer undertones, and coat ratios.
                    </p>
                  </div>

                  {loadingAI && (
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8 text-center space-y-3 animate-pulse">
                  ...
                  {!loadingAI && !aiMatch && !aiError && (
                    <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 sm:p-8 text-center text-slate-500 space-y-2">
                  ...
                  {aiError && (
                    <div className="bg-rose-950/20 border border-rose-900/30 rounded-2xl p-5 sm:p-6 text-center space-y-2">
                  ...
                  {aiMatch && (
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-3.5 text-xs text-left">
                      ...
                      <div>
                        <span className="text-slate-500 text-[9px] font-bold uppercase block mb-0.5">
                          Verified Color
                        </span>
                        <span className="text-slate-200 font-extrabold text-sm">
                          {aiMatch.matchingColorName}
                        </span>
                      </div>
                      <div className="grid grid-cols-2 gap-2">
                        <div className="bg-slate-950 p-2 rounded-lg border border-slate-800">
                          <span className="text-slate-500 text-[8px] font-bold uppercase block">
                            OEM Code
                          </span>
                          <span className="text-white font-bold text-xs">
                            {aiMatch.typicalColorCodes}
                          </span>
                        </div>
                        <div className="bg-slate-950 p-2 rounded-lg border border-slate-800">
                          <span className="text-slate-500 text-[8px] font-bold uppercase block">
                          ...
                          <span className="text-white font-bold text-xs">
                            {aiMatch.primerRecommendation?.split(' ')[0]}
                          </span>
                        </div>
                      </div>
                      <div>
                        <span className="text-slate-500 text-[9px] font-bold uppercase block mb-1">
                          Refinishing Layers
                        </span>
                ...
                {/* Help Card */}
                <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-5 border border-neutral-200 space-y-3">
                  ...
                  <div className="bg-orange-50 border border-orange-100 rounded-xl p-3 text-[11px] leading-relaxed text-orange-800 flex gap-2">
                    ...
                    <span>
                      Can't find the code? Upload a photo of the door pillar and our chemists
